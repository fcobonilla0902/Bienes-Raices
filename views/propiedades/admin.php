<main class="contenedor seccion">
    ...
    <?php
        if($resultado){
            $mensaje = mostrarNotificacion(intval($resultado)); // intval lo hace int
        ...
        <tbody><!-- mostrar los resultados -->
            ...
            <tr>
                ...
                <td> 
                    ...
                    <form action="/propiedades/eliminar" method="POST" action="" class="w-100">
        ...
        <table class="propiedades">
            ...
            <tbody><!-- mostrar los resultados -->
                ...
                <tr>
                    ...
                    <td> 
                        <a href="/vendedores/actualizar?id=<?php echo $vendedor->id;?>" class="boton-amarillo-actualizar">Actualizar</a>
